...
class Response extends Message implements ResponseInterface
{
    ...
    /**
     * @var string The reason phrase associated with the status code.
     */
     ...
     */
    public function __construct($statusCode = 200, array $headers = [], $body = '', $version = '1.1', $reasonPhrase = 'OK')
    {
    ...
    /**
     * Returns an instance with the specific status code and reason phrase.
     *
    ...
    {
        return  static::$statusTexts[$this->statusCode] ?? $this->reasonPhrase;
    }
